...
def run(path):
    ...
    start = time.time()
    try:
        #mmap(0x41414000, 0x1000, PROT_READ|PROT_WRITE|PROT_EXEC, MAP_ANON|MAP_PRIVATE|MAP_FIXED, -1, 0)
        chain = rop.func_call('mmap', [0x41414000, 0x1000, 7, 50, -1, 0], needs_return=False)
