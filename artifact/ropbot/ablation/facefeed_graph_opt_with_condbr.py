...
def run(path):
    ...
    start = time.time()
    try:
        rop.chain_builder._reg_setter.find_candidate_chains_giga_graph_search(None, {'rdi': RopValue(0xdeadbeef, proj), 'rsi': RopValue(0x40, proj), 'rdx': RopValue(0x7b, proj)}, {}, False)
