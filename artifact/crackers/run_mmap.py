...
CONFIG_TEMPLATE_PATH = '/experiment/templates/mmap_config.toml.j2'
SPEC_PATH = '/experiment/mmap.o'
SPEC_SRC_PATH = '/experiment/mmap.s'
SPEC_SRC_TEMPLATE_PATH = '/experiment/templates/mmap.s.j2'
...
def run(path):
    ...
    with open(SPEC_SRC_PATH, 'w') as f:
        data = spec_src_template.render(mmap_addr=mmap_addr)
        f.write(data+'\n')
